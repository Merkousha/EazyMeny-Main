...
#### 19. هوش مصنوعی در منو و پشتیبانی (AI-Assisted Menu & Chat) 🔵 75%
**تکمیل شده:**
...
- ✅ پیاده‌سازی لیست محصولات در پنل رستوران با نمایش جدول، وضعیت‌ها و عملیات CRUD
- ✅ SignalR Hub برای چت تعاملی با AI در صفحه منو (AiAssistantHub)
- ✅ API برای ارسال پیام کاربر و لیست منو به AI (SendMessage, GetChatHistory)
- ✅ ذخیره تاریخچه گفتگو در دیتابیس (ChatHistory Entity)
- ✅ ViewComponent برای نمایش ویجت چت (ChatWidgetViewComponent)
- ✅ بهبود UX چت: اسکرول خودکار به آخرین پیام
- ✅ Sticky input box در پایین پنجره چت
- ✅ Smooth scroll behavior و افزایش ارتفاع پنجره

**نیاز به توسعه:**
- ⬜ دکمه تولید توضیح و تصویر محصول با هوش مصنوعی (Semantic Kernel)
- ⬜ تنظیمات BaseUrl و مدل در پنل مدیریت (ApiKey موجود است)
